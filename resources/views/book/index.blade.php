                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   <input type="hidden" name="product_id" id="product_id">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="book_name" name="book_name" placeholder="Enter Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                        <input type="text" class="form-control" id="author_name" name="author_name" placeholder="Enter Phone" value="" maxlength="50" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Price</label>
                        <div class="col-sm-12">
                        <input type="number" class="form-control" id="price" name="price" placeholder="Price" value="" maxlength="50" required="">
                        </div>
                    </div>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editProduct', function () {
      ...
      $.get("{{ route('book.index') }}" +'/' + product_id +'/edit', function (data) {
    ...
    $('body').on('click', '.deleteProduct', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('book.store') }}"+'/'+product_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
